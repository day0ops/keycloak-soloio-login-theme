    ...
    useEffect(() => {
        ...
        style.textContent = `
            ...
            *, *::before, *::after { font-family: 'Geist', 'Open Sans', sans-serif !important; box-sizing: border-box !important; }
            ...
            label { color: rgba(255,255,255,0.7) !important; font-size: 13px !important; margin-bottom: 6px !important; }
            ...
            .kc-label-wrapper .kc-label { color: rgba(255,255,255,0.7); font-size: 13px; margin-bottom: 0; display: inline; }
            .kc-input-wrapper { width: 100%; }
            .kc-input-error { color: #ff6b7a !important; font-size: 12px !important; margin-top: 4px !important; display: block !important; }
            ...
            .kcInputErrorMessageClass, span[aria-live] { color: #ff6b7a !important; font-size: 12px !important; margin-top: 4px !important; display: block !important; }
        `;
