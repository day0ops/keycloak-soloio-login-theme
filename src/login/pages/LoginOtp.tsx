                            ...
                            <Fragment key={index}>
                                ...
                                <label
                                    ...
                                    style={{
                                        ...
                                        alignItems: "center",
                                        padding: "10px 14px",
                                        backgroundColor: otpCredential.id === otpLogin.selectedCredentialId ? "rgba(123,51,234,0.15)" : "#27243D",
                                        border: otpCredential.id === otpLogin.selectedCredentialId ? "1px solid rgba(123,51,234,0.5)" : "1px solid #4F556B",
                                        borderRadius: "6px",
                                        cursor: "pointer",
                                        color: "#ffffff",
                                        fontSize: "15px",
